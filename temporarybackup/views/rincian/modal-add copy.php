      ...
      <div class="modal-body">
        <div class="row">
          ...
          <div class="col-3"><label class="sifunglabel">Nafsu makan & minum</label>
            <?php echo form_dropdown('tblnafsu',$tblnafsu,1,'id="cmbNafsu" class="form-control mb-2 mr-sm-2 sifungtext"  data-dropdown-css-class="select2-danger sifung-autocomplete" style="height:40px;" style="height:40px" ');?>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-3"><label class="sifunglabel">Keadaan hewan saat berdiri</label>
            <?php echo form_dropdown('tblpresen',$tblpresen,1,'id="cmbPenampakan" class="form-control mb-2 mr-sm-2 sifungtext"  data-dropdown-css-class="select2-danger sifung-autocomplete" style="height:40px;" style="height:40px" ');?>
          </div>
        ...
        <div class="row">
          <div class="col-3"><label class="sifunglabel">Asal</label>
              ...
              <div class="asaldaerah">
                <?php echo form_dropdown('asaldaerah',$asaldaerah,1,'id="cmbAsalDaerah" class="form-control mb-2 mr-sm-2 sifungtext addasaldaerah domainppk"  data-dropdown-css-class="select2-danger sifung-autocomplete" style="height:40px;" style="height:40px;display:none" ');?>
              </div>
            </div>
          <div class="col-3"><label class="sifunglabel">Kondisi Alat Angkut</label>
            <?php echo form_dropdown('tblsikonangkut',$tblsikonangkut,1,'id="cmbKondisiAngkutan" class="form-control mb-2 sifungtext mr-sm-2"  data-dropdown-css-class="select2-danger sifung-autocomplete" style="height:40px;"');?>            </div>
            <div class="col-3"><label class="sifunglabel">Suhu standard normal</label>
            <?php echo form_dropdown('cmbSuhu',$tblsuhu,1,'id="cmbSuhu" class="form-control mb-2 mr-sm-2 sifungtext"  data-dropdown-css-class="select2-danger sifung-autocomplete" style="height:40px;" style="height:40px" ');?>
            </div>
        ...
        <div class="row">
          <div class="col-3"><label class="sifunglabel">Tujuan</label>
              <div class="tujuannegara">
                <?php echo form_dropdown('tujuannegara',$asalnegara,1,'id="cmbTujuannegara" class="form-control mb-2 mr-sm-2 sifungtext addtujuannegara domainppk"  data-dropdown-css-class="select2-danger sifung-autocomplete" style="height:40px;"');?>
              </div>
              <div class="tujuandaerah">
                <?php echo form_dropdown('tujuadaerah',$asaldaerah,1,'id="cmbTujuanDaerah" class="form-control mb-2 mr-sm-2 sifungtext addtujuandaerah domainppk"  data-dropdown-css-class="select2-danger sifung-autocomplete" style="height:40px;" style="height:40px;display:none" ');?>
              </div>
            </div>
            <div class="col-3">
            </div>
        <div class="col-3"><label class="sifunglabel">Hasil pemeriksaan suhu</label>
            <input type="text" class="form-control mb-2 mr-sm-2 sifungtext" placeholder="Hasil Pemeriksaan Suhu" id="txtSuhuriil">
        </div>
