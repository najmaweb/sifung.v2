...
function createNarration(){
    $text = "Memperhatikan hasil rekam medis terkait dengan informasi pemilik, informasi negara/daerah asal hewan, informasi jenis hewan, status present dan dokumen lain yang menyertai \n";
    $text.= "Nama Pemilik \n";
    $text.= "Jenis Hewan \n";
    $text.= "Daerah/negara asal hewan \n";
    $text.= "Alat angkut:jenis, kondisi \n";
    $text.= "Hasil rekam status present: ciri-ciri hewan, nafsu makan dan minum, keadaan berdiri hewan, kondisi bulu,adanya discharge,adanya eksudat \n";
    $text.= "Anamnesa: riwayat sakit/vaksinasi \n";
    return $text;
}
