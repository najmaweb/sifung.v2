      ...
      <div class="modal-body">
        <div class="row">
          ...
          <div class="col-3"><label class="sifunglabel">Kondisi Alat Angkut</label>
            <?php echo form_dropdown('tblsikonangkut',$tblsikonangkut,1,'id="cmbEditKondisiAngkutan" class="form-control mb-2 sifungtext mr-sm-2"  data-dropdown-css-class="select2-danger sifung-autocomplete" style="height:40px;"');?>            
          </div>
