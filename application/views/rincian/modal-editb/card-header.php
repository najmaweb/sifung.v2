<div class="card-header p-0 pt-1">
    <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
        ...
        <li class="nav-item">
        <a class="nav-link" id="klinisTab" data-toggle="pill" href="#tabKlinis" role="tab" aria-controls="tabKlinis" aria-selected="false">Organoleptik</a>
        </li>
        <li class="nav-item">
        <a class="nav-link" id="penilaianklinisTab" data-toggle="pill" href="#penilaianKlinis" role="tab" aria-controls="tabKlinis" aria-selected="false">Penilaian Pemeriksaan Organoleptik</a>
        </li>
        <li class="nav-item">
